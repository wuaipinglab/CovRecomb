'''
Function: The core algorithm for the CovRecomb method to detect inter-lineage recombinants.
'''
...
def recombination_detection_test(Strain_list_snp, len_UAB, linA_list, variants_all, feature_mutations, Lineage_v, mutaions_num):
    ...
    for epi in Strain_list_snp:
        ...
        if (CH1 == CH2) and (most_one == most_two):  # Not recombinant, recognized as not recombinant (CORRECT)
            zhenyin += 1

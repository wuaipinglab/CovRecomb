...
seed_gen = 5 
temp_file = code_path = "/home/soniali/Desktop/03_CovRecomb/Simulation_Test/HOMO_probability/"
creat_dir(temp_file)
generations_list = [6]
turns_list = 5
sample_rate = 5
...
with open(temp_file+"HOMO_probability.txt","a+") as f:
            f.write(",".join(column_names)+"\n")


for parallel_prop in [0.1,0.5,0.8]:

...
def main(lin_diff_num_list, candi_file):
    ...
    for num in lin_diff_num_list:
        ...
        for gen in candi_file:
            ...
            gener_num = gen.split("Generation")[1].split("_SR")[0]
    ...
    labels = list(generation_sample_size.values())
    for need_ld in lin_diff_num_list:
        ...
        plt.scatter(x, y1, color="#DE8448", label="3seq")
        plt.scatter(x, y2, color="#4F75BB", label="ovRecomld")
...
if __name__ == '__main__':
    candi_file = ["Sampler_Generation8_SR_50", "Sampler_Generation8_SR_75", "Sampler_Generation8_SR_100"]
